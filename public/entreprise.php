...
// Fetch avis
$stmt2 = $pdo->prepare("SELECT * FROM avis WHERE entreprise_id = ? ORDER BY date_creation DESC");
$stmt2->execute([$id]);
...
<title><?= $entreprise['nom'] ?> - Annuaire</title>
...
<div class="container mt-4">
  ...
  <div class="row">
    ...
    <!-- Right column: Map + Reviews + Add review -->
    <div class="col-lg-8">
      <!-- Map -->
